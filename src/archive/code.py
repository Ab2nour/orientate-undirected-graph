...
plot_couleur = lambda arbre: arbre.plot(
    edge_colors=arbre._color_by_label(options_couleurs)
)
...
def affiche_infos(g):
    ...
    print(
        f"sommets d'articulation : {informations['sommets_articulation']}", end="\n\n"
    )
